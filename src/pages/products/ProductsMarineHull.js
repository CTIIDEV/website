...
const ProductsMarineHull = () => {
  const { Panel } = Collapse;

  const style = {
    background:
      "linear-gradient(135deg, hsla(196, 100%, 35%, 1) 0%, hsla(156, 100%, 37%, 1) 100%)",
    color: "#FFF",
    position: "relative",
    height: "341px",
  };
        ...
        <div className="banner-elem">
          <div className="text-wrapper text-left">
            <div className="introduction">
              <h1>Marine Hull</h1>
              <h3>Lorem Ipsum si Amet</h3>
            </div>
            <Button type="primary" style={{ marginRight: "14px" }}>
              Buy Product
            </Button>
            <Button type="primary" href="#contactForm">
              Send Enquiry
            </Button>
          </div>
        </div>
...
export default ProductsMarineHull;
